          ...
          <div className="col-sm-3 cardContainer">
            <div className="card cardHover">
              ...
              {t.category === "Art" && (
                ...
                >
                  <div className="categoryClass">{t.category}</div>
                </div>
              )}
              {t.category === "Photograph" && (
                <div
                  className="trapezoid"
                ...
                <div className="card-block">
                  ...
                  <div className="row">
                    ...
                    {/* <div className="col-1">
                      ...
                      >
                        {({ blob, url, loading, error ,t}) => (
                          // loading ? "Loading document..." : "Download now!"
                          <i className="fa fa-download fa-lg black downloadIcon text-right mr-3 mt-2" ></i>
                        )}
                      </PDFDownloadLink>
                    </div> */}
                    <div className="col-9">
